...
import CotacoesOrcamentos from "./pages/CotacoesOrcamentos";
...
import DashboardCQ from "./pages/CQ/DashboardCQ";
import PlanilhasCQ from "./pages/CQ/PlanilhasCQ";
import AgendamentoCQ from "./pages/CQ/AgendamentoCQ";
import MelhoriaContinuaCQ from "./pages/CQ/MelhoriaContinuaCQ";
import RastreabilidadeCQ from "./pages/CQ/RastreabilidadeCQ";
import RelatoriosCQ from "./pages/CQ/RelatoriosCQ";
import CadastrosCQ from "./pages/CQ/CadastrosCQ";
import ConfiguracoesCQ from "./pages/CQ/ConfiguracoesCQ";
import ExecucaoCQ from "./pages/CQ/ExecucaoCQ";
      ...
      <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        <Routes>
          ...
          <Route path="/gestao-tarefas" element={<AuthGuard><GestaoTarefas /></AuthGuard>} />
           ...
           {/* Controle de Qualidade */}
           <Route path="/dashboard-cq" element={<AuthGuard><DashboardCQ /></AuthGuard>} />
           <Route path="/planilhas-cq" element={<AuthGuard><PlanilhasCQ /></AuthGuard>} />
           <Route path="/agendamento-cq" element={<AuthGuard><AgendamentoCQ /></AuthGuard>} />
           <Route path="/melhoria-continua-cq" element={<AuthGuard><MelhoriaContinuaCQ /></AuthGuard>} />
           <Route path="/rastreabilidade-cq" element={<AuthGuard><RastreabilidadeCQ /></AuthGuard>} />
           <Route path="/relatorios-cq" element={<AuthGuard><RelatoriosCQ /></AuthGuard>} />
           <Route path="/cadastros-cq" element={<AuthGuard><CadastrosCQ /></AuthGuard>} />
                       <Route path="/configuracoes-cq" element={<AuthGuard><ConfiguracoesCQ /></AuthGuard>} />
            <Route path="/execucao-cq" element={<AuthGuard><ExecucaoCQ /></AuthGuard>} />
          ...
          <Route path="/cotacoes-orcamentos" element={<AuthGuard><CotacoesOrcamentos /></AuthGuard>} />
