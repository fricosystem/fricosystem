      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">Esta divulgação fornece informações importantes sobre o programa de licença do APEX ERP e as responsabilidades dos licenciados.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>Procedimentos operacionais do APEX ERP</li>
