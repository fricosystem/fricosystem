      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">O APEX ERP, desenvolvido pela ATOM Corp., está comprometido em garantir a acessibilidade digital para pessoas com deficiência. Melhoramos continuamente a experiência do usuário para todos e aplicamos os padrões de acessibilidade relevantes.</p>
          </section>
