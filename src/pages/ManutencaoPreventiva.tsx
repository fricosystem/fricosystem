...
import { Plus, Search, Calendar, CheckCircle, AlertCircle, Clock, Settings } from "lucide-react";
...
export default function ManutencaoPreventiva() {
  ...
  useEffect(() => {
    const qTarefas = query(collection(db, "tarefas_manutencao"), orderBy("proximaExecucao", "asc"));
              ...
              <TableBody>
                {tarefasFiltradas.map((tarefa) => (
                  <TableRow key={tarefa.id}>
                    ...
                    <TableCell className="font-medium">{tarefa.maquinaNome}</TableCell>
