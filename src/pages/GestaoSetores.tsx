...
import { Plus, RefreshCw, Pencil, Trash2, Factory } from "lucide-react";
...
const GestaoSetores = () => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      await deleteDoc(doc(db, "setores", setorToDelete.id));
      toast({
        title: "Sucesso",
  ...
  return (
    <AppLayout title="Gestão de Setores">
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Tem certeza que deseja excluir o setor "{setorToDelete?.nome}"? Esta ação não pode ser desfeita.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
