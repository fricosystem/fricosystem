        ...
        <div className="w-full px-2 md:px-4 flex items-center justify-between">
          <div className="flex items-center gap-2 pl-1">
            <a href="#hero" className="flex items-center gap-2">
              ...
              />
              <div>
                <span className="text-2xl font-bold text-white">APEX ERP</span>
        ...
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-16">
          <div className="container mx-auto relative z-10 px-4 flex flex-col items-center text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate-fade-in">
              ...
              <br />
              <span className="text-3xl md:text-4xl text-frico-500">APEX ERP</span>
            </h1>
            
            <p className="text-xl text-gray-500 max-w-2xl mb-8 animate-fade-up">
              O APEX ERP transforma a gestão corporativa com soluções integradas para estoque, finanças, recursos humanos e muito mais. Fazemos com que a empresa alcançe a excelência operacional.
            </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto text-xl">
                O APEX ERP foi desenvolvido para atender as necessidades específicas da empresa, 
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-xl h-64 overflow-hidden backdrop-blur-sm">
                  <iframe 
                    ...
                    width="100%" height="100%" style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Localização da APEX ERP" className="rounded-lg"
                  ></iframe>
                </div>
              </div>
            </div>
      ...
      <footer className="py-12 border-t border-gray-800/50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-white text-lg font-bold mb-4">APEX ERP</h3>
