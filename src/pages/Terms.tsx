        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
            <section>
              ...
              <p>
                Ao acessar e usar o sistema APEX ERP, você aceita e concorda em estar vinculado aos termos e disposições deste acordo. Estes Termos de Serviço regem o uso do nosso sistema e serviços.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                É concedida permissão para uso do sistema APEX ERP conforme os termos da sua licença. Esta é a concessão de uma licença, não uma transferência de título, e sob esta licença você não pode:
              </p>
            ...
            <section>
              ...
              <p>
                Em nenhum caso a ATOM Corp. ou seus fornecedores serão responsáveis por quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro, ou devido à interrupção dos negócios) decorrentes do uso ou incapacidade de usar o sistema APEX ERP.
              </p>
            </section>
