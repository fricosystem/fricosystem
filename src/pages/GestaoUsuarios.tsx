...
const PERMISSOES_AGRUPADAS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'baixa-requisicao', label: 'Baixa Requisição' },
  ...
  },
  {
    ...
    items: [
      { id: 'dashboard_manutencao', label: 'Dashboard Manutenção' },
      { id: 'maquinas', label: 'Máquinas' },
      { id: 'manutencao_preventiva', label: 'Manutenção Preventiva' },
      { id: 'execucao_preventiva', label: 'Execução de Manutenção' },
  ...
  },
  {
    ...
    items: [
      { id: 'dashboard-cq', label: 'CQ - Dashboard' },
      { id: 'execucao-cq', label: 'CQ - Execução' },
      { id: 'planilhas', label: 'CQ - Planilhas' },
      { id: 'agendamento-cq', label: 'CQ - Agendamento' },
      { id: 'melhoria-continua-cq', label: 'CQ - Melhoria Contínua' },
      { id: 'rastreabilidade-cq', label: 'CQ - Rastreabilidade' },
      { id: 'relatorios_qc', label: 'CQ - Relatórios' },
      { id: 'cadastros_qc', label: 'CQ - Cadastros' },
      { id: 'configuracoes_qc', label: 'CQ - Configurações' },
    ]
  },
  {
            ...
            <div className="space-y-6 p-2">
              {PERMISSOES_AGRUPADAS.map((grupo) => (
                <div key={grupo.categoria} className="space-y-3">
                  <h4 className="text-sm font-black text-cyan-500 uppercase tracking-widest border-b border-slate-800 pb-1">
                    {grupo.categoria}
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {grupo.items.map(permissao => (
                      <div key={permissao.id} className="flex items-center space-x-2 bg-slate-900/40 p-2 rounded-lg border border-transparent hover:border-slate-800 transition-colors">
                        <Checkbox
                        ...
                        />
                        <Label htmlFor={`permissao-${permissao.id}`} className="text-xs font-medium leading-none cursor-pointer">
                          {permissao.label}
                        </Label>
                      </div>
                    ))}
