...
const Produtos = () => {
  ...
  const produtosFiltrados = produtos ? sortProdutos(produtos.filter(produto => {
    ...
    return safeToLowerCase(produto.nome).includes(termoBusca) || 
          ...
          {loading ? (
            ...
            <div className="flex-1 flex items-center justify-center">
              <EmptyState 
                ...
                description={searchTerm ? "Nenhum produto corresponde à sua busca." : error ? "Ocorreu um erro ao carregar os dados. Tente novamente." : "Adicione novos produtos para começar."} 
              />
            </div>
          ) : (
            <>
              ...
              {/* Paginação - Agora fixa na parte inferior */}
              {totalPages > 1 && (
