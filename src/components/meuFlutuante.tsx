  ...
  const menuCategories = [
    ...
    },
    {
      ...
      items: filterItemsByPermission([
        ...
        { id: "baixa-requisicao", icon: <ClipboardCheck size={20} />, label: "Baixa Requisição", path: "/baixa-requisicao", permission: "baixa-requisicao" },
    ...
    },
    {
      ...
      items: filterItemsByPermission([
        { id: "execucao-cq", icon: <Scan size={20} />, label: "Execução", path: "/execucao-cq", permission: "execucao-cq" },
        { id: "dashboard-cq", icon: <FileText size={20} />, label: "Dashboard", path: "/dashboard-cq", permission: "dashboard-cq" },
        { id: "planilhas-cq", icon: <FileText size={20} />, label: "Planilhas", path: "/planilhas-cq", permission: "planilhas" },
        { id: "agendamento-cq", icon: <FileText size={20} />, label: "Agendamento", path: "/agendamento-cq", permission: "agendamento-cq" },
        { id: "melhoria-continua-cq", icon: <AlertTriangle size={20} />, label: "Melhoria Contínua", path: "/melhoria-continua-cq", permission: "melhoria-continua-cq" },
        { id: "rastreabilidade-cq", icon: <AlertTriangle size={20} />, label: "Rastreabilidade", path: "/rastreabilidade-cq", permission: "rastreabilidade-cq" },
        { id: "relatorios-cq", icon: <FileSpreadsheet size={20} />, label: "Relatórios", path: "/relatorios-cq", permission: "relatorios_qc" },
        { id: "cadastros-cq", icon: <FileSpreadsheet size={20} />, label: "Cadastros", path: "/cadastros-cq", permission: "cadastros_qc" },
        { id: "configuracoes-cq", icon: <FileSpreadsheet size={20} />, label: "Configurações", path: "/configuracoes-cq", permission: "configuracoes_qc" },
      ]),
    },
    ...(isAdmin ? [{
      id: "administrativo",
      ...
      items: filterItemsByPermission([
        ...
        { id: "gestao-fornecedores", icon: <Building size={20} />, label: "Gestão de Fornecedores", path: "/gestao-fornecedores", permission: "fornecedores" },
    ...
    ...(isAdmin ? [{
      ...
      items: filterItemsByPermission([
        ...
        { id: "apex-chat", icon: <MessageSquare size={20} />, label: "APEX Chat", path: "/apex-chat" },
      ]),
    }] : []),
    {
      id: "sistema",
