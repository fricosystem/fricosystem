      ...
      <>
        <Card className="overflow-hidden h-full flex flex-col">
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-4xl w-[95vw] p-0 overflow-hidden">
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-4 sm:p-6 overflow-y-auto max-h-[80vh]">
                      <DialogHeader className="mb-4 sm:mb-6">
                        <DialogTitle className="text-xl font-bold tracking-tight text-balance">
                          {produto.nome}
                        </DialogTitle>
                        <DialogDescription className="text-sm text-muted-foreground text-wrap">
                      ...
                      <div className="space-y-6">
                        ...
                        {produto.detalhes && (
                          <div className="space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground whitespace-pre-line text-wrap">
                              {produto.detalhes}
                            </p>
                          </div>
                        )}
                      ...
                      <div className="mt-8 pt-4 border-t flex flex-col sm:flex-row flex-wrap gap-2 justify-end">
                        <AdicionarAoCarrinho 
                          produto={produto} 
          ...
          <CardContent className="pt-4 flex-grow">
            ...
            {/* ...demais elementos do CardContent, se houver... */}
          </CardContent>
        </Card>
      </>
    );
