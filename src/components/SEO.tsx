...
const SEO: React.FC<SEOProps> = ({
  title = 'APEX ERP',
  description = 'APEX ERP: Sistema ERP completo para gestão industrial, desenvolvido pela ATOM Corp.',
  type = 'website',
  name = 'APEX ERP - ATOM Corp.',
  imageUrl = 'https://res.cloudinary.com/diomtgcvb/image/upload/v1768956525/APEX_LOGO_ssi5g2.png',
  publishDate,
  modifiedDate,
  author,
  category,
  keywords = ['ERP', 'gestão industrial', 'sistema de gestão', 'ATOM Corp', 'APEX ERP', 'controle de produção'],
  isBlogPost = false
}) => {
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    author: {
      '@type': 'Organization',
      name: author || 'APEX ERP - ATOM Corp.',
      url: 'https://apexhub.atomcorp.com.br'
    },
    publisher: {
      '@type': 'Organization',
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="APEX ERP - ATOM Corp." />
