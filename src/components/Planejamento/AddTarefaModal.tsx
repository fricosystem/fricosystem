        ...
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription>
                Crie uma nova tarefa de desenvolvimento com detalhes completos
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
          ...
          <div className="grid gap-5 py-4">
            ...
            <div className="flex items-center space-x-3 p-3 rounded-lg border bg-muted/30">
              ...
              >
                ...
                Marcar tarefa como concluída imediatamente
              </Label>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
              <p className="text-xs text-blue-700 dark:text-blue-300 flex items-start gap-2">
                ...
                Após criar a tarefa, você poderá adicionar etapas detalhadas de desenvolvimento diretamente no card da tarefa.
              </p>
            </div>
          </div>
