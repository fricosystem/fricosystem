...
interface BottomNavigationOSProps {
  activeTab: TabType;
  onTabChange: (tab: TabType) => void;
  badgeCount?: number;
}

export function BottomNavigationOS({ activeTab, onTabChange, badgeCount }: BottomNavigationOSProps) {
  const tabs = [
    { id: "nova-os" as const, label: "Nova OS", icon: ClipboardList, hasBadge: true },
