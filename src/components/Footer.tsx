      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6">
              APEX ERP é um sistema ERP completo para gestão industrial, desenvolvido pela ATOM Corp. para otimizar processos e aumentar a eficiência operacional.
            </p>
            <p className="text-gray-300 mb-6">
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} APEX ERP - ATOM Corp. Todos os direitos reservados.
          </p>
